...
To build the final jar and optimize the AppswiftDem application for production, run:
...
Then navigate to [http://localhost:8008](http://localhost:8008) in your browser.
