package com.cg.appswiftdem.config.timezone;

import com.cg.appswiftdem.AppswiftDemApp;
import com.cg.appswiftdem.repository.timezone.DateTimeWrapper;
import com.cg.appswiftdem.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM cg_date_time_wrapper where id=%d", fieldName, id);
    }
